...
helpolsepakker = int(polsepakker) * 10
helbrodpakker = int(brodpakker) * 8


helpolsepakker %= polser_totalt
helbrodpakker %= brod_totalt

print(f"Du får {helpolsepakker} pølser til overs")
print(f"Du får {helbrodpakker} pølsebrød til overs")

# PS!!!: Prøvde å bruke % til å gjøre koden mer effektiv, klarte ikke det, men du kan se den originale koden min, den står i psuedo-filen